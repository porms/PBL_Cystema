...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="cystemaaccessories.css">
...
$category = "Accessories"; // Specify the category you want to display
...
while ($row = mysqli_fetch_array($result)) {
    ...
    if ($counter % 5 == 0) {
        ...
        echo "</ul><ul class='accessories-list'>";
    }
}
